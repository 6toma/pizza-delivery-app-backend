...
class JwtUserDetailsServiceTest {
    ...
    void loadUserByUsernameFound() {
        ...
        var user = new AppUser(email, role, password);
        when(userRepository.findByEmail(any())).thenReturn(Optional.of(user));

        var result = userDetailsService.loadUserByUsername("user@gmai.com");
        assertNotNull(result);
        assertEquals(email.toString(), result.getUsername());
    ...
    void loadUserByUsernameNotFound() {
        ...
        assertThrows(UsernameNotFoundException.class, () -> userDetailsService.loadUserByUsername("username@gmail.com"));
    }
}
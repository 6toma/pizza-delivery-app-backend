...
public class RegionalManagerDataLoader implements ApplicationRunner {
    ...
    private static final UserEmail REGIONAL_MANAGER_EMAIL = new UserEmail("regionalmanager@ap.nl");
    ...
    public void run(ApplicationArguments args) {
        if (userRepository.findAllByRole(UserRole.REGIONAL_MANAGER).isEmpty()) {
            ...
            if (hashedPassword != null) {
                var user = new AppUser(REGIONAL_MANAGER_EMAIL, UserRole.REGIONAL_MANAGER, hashedPassword);
